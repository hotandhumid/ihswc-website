...
class CreateUserForm(forms.Form):
    ...
    pdf_file1 = forms.FileField(required=False, label="pdf file 1")
    ...
    pdf_file2 = forms.FileField(required=False, label="pdf file 2")
    ...
    pdf_file3 = forms.FileField(required=False, label="pdf file 3")
    ...
    pdf_file4 = forms.FileField(required=False, label="pdf file 4")
